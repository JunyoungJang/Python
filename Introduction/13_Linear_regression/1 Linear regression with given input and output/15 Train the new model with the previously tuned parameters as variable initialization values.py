...
with tf.Session() as Recall_Linear_regression:
    ...
    for step_index in range(EPOCH_2): # This line is changed ---------------------------------------------------------------------
        if step_index % DISPLAY_STEP_2 != 0: # This line is changed --------------------------------------------------------------
            Recall_Linear_regression.run(train_2, feed_dict=feed_info_2) # This line is changed ----------------------------------
        if step_index % DISPLAY_STEP_2 == 0: # This line is changed --------------------------------------------------------------
            _, cost_2_now, w_2_now, b_2_now = Recall_Linear_regression.run([train_2, cost_2, w_2, b_2], feed_dict=feed_info_2) # This line is changed ----------
            ...
            print 'Cost : ', cost_2_now # This line is changed -------------------------------------------------------------------
            print 'Weight : ', w_2_now # This line is changed --------------------------------------------------------------------
            print 'Bias : ', b_2_now # This line is changed ----------------------------------------------------------------------
            print 'Bias : ', b_2_now # This line is changed ----------------------------------------------------------------------

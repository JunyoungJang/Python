...
with tf.Session() as Recall_Linear_regression:
    ...
    # predict output for a new input data
    x_data_new = [[0.]] # This line is changed -----------------------------------------------------------------------------------
    y_data_predicted = Recall_Linear_regression.run(hypothesis_2, feed_dict={x_2: x_data_new}) # This line is changed ------------
    print 'New input : ', x_data_new # This line is changed ----------------------------------------------------------------------
    print 'Predicted output : ', y_data_predicted # This line is changed ---------------------------------------------------------

    x_data_new = [[7.], [-3], [-2.]] # This line is changed ----------------------------------------------------------------------
    y_data_predicted = Recall_Linear_regression.run(hypothesis_2, feed_dict={x_2: x_data_new}) # This line is changed ------------
    print 'New input : ', x_data_new # This line is changed ----------------------------------------------------------------------
    print 'Predicted output : ', y_data_predicted # This line is changed ---------------------------------------------------------

    x_data_new = [[7.]]  # This line is changed ----------------------------------------------------------------------------------
    y_data_predicted, w_2_now, b_2_now = Recall_Linear_regression.run([hypothesis_2, w_2, b_2], feed_dict={x_2: x_data_new})  # This line is changed ----------
    print 'New input : ', x_data_new  # This line is changed ----------------------------------------------------------------------
    print 'Predicted output : ', y_data_predicted  # This line is changed ---------------------------------------------------------
    print 'w_2 : ', w_2_now # This line is changed --------------------------------------------------------------------------------
    print 'b_2 : ', b_2_now # This line is changed --------------------------------------------------------------------------------

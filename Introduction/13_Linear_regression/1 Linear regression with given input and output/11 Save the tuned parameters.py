...
parameter_list = [w, b] # Which one to save. This line is changed -----------------------------------------------------------------------------------
saver = tf.train.Saver(parameter_list) # Which one to save. This line is changed --------------------------------------------------------------------
...
with tf.Session() as Linear_regression:
    ...
    saver.save(Linear_regression, SAVE_PATH) # Action. This line is changed --------------------------------------------------------------

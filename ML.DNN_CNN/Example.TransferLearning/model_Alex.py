...
model = tflearn.DNN(network, checkpoint_path='jun_ALEX_cat_dog.tflearn', max_checkpoints=1,
                    tensorboard_verbose = 3, tensorboard_dir='tmp/tflearn_logs/')
model.fit(trainX, trainY, n_epoch=100, validation_set=(testX, testY), shuffle=True,
          show_metric=True, batch_size=64, snapshot_step=200,
          snapshot_epoch=False, run_id='jun_cat_dog')
model.save('jun_ALEX_cat_dog_final.tflearn')